...
<p style='text-align: justify;'> Our work typically involves observing certain phenomena and replicating them through desktop-scale lab experiments. Based on these experiments and observations, we develop a mechanical model and implement it numerically to generate predictions. We then compare these predictions with experimental results to refine and validate our model.</p>
